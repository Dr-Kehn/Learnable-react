...
const JobList: React.FC = () => {
  return (
    <div className="max-w-5xl mx-auto py-10 px-6">
      <h1 className="text-3xl font-bold text-gray-800 text-center mb-6">🚀 Job Listings</h1>
      ...
      {jobs.length > 0 ? (
        ...
        <p className="text-red-600 text-center text-lg mt-5">No jobs available at the moment.</p>
      )}
    </div>
  );
};
